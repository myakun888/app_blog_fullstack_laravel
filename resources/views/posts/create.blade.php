        ...
        <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow">
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="body" rows="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required></textarea>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('posts.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700">Cancel</a>
